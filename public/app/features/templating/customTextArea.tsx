...
import { validate, EventsWithValidation, hasValidationEvent } from '@grafana/ui/src';
import { ValidationEvents, ValidationRule } from '@grafana/ui/src';

export enum InputStatus { // adicionado // FICHEIRO CRIADO POR MIM. NÃO EXISTE NO GRAFANA
  Invalid = 'invalid',
  Valid = 'valid',
}
  ...
  render() {
    ...
    return (
      <div style={{ flexGrow: 1 }}>
        <textarea {...inputElementProps} className={inputClassName} rows={10} />
        <input {...inputElementProps} className={inputClassName} style={{ display: 'none' }} />
